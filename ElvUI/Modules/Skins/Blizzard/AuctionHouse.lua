...
S:AddCallbackForAddon("Blizzard_AuctionUI", "Skin_Blizzard_AuctionUI", function()
	...
	local y = (IsAddOnLoaded("TradeSkillMaster_AuctionDB") or IsAddOnLoaded("TradeSkillMaster_Auctioning") or IsAddOnLoaded("TradeSkillMaster_Shopping")) and 0 or 23
	...
	for i = 1, AuctionFrame.numTabs do
		...
		if i == 1 then
			y = (IsAddOnLoaded("TradeSkillMaster_AuctionDB") or IsAddOnLoaded("TradeSkillMaster_Auctioning") or IsAddOnLoaded("TradeSkillMaster_Shopping")) and 2 or 25
